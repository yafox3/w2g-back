...
public class RoomController {
    ...
    public ResponseEntity<?> createRoom(@RequestParam String username, @RequestParam String accessToken) {
        return ResponseEntity.status(HttpStatus.CREATED).body(roomService.createRoom(username, accessToken));
    }
